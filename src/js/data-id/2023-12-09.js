...
dataSet[dataSetVersion].options = [
  ...
  {
    name: "Kecualikan Trailblazer",
    key: "trailblazer",
    tooltip: "Centang ini untuk mengecualikan Trailblazer.",
    checked: false
  },
  {
    name: "Kecualikan duplikat Trailblazer",
    key: "tbpath",
    tooltip: "Centang ini untuk mengecualikan duplikat Trailblazer berdasarkan Path dan hanya menampilkan versi The Destruction.",
    checked: false
  },
  {
    name: "Kecualikan versi alter",
    key: "alter",
    tooltip: "Centang ini untuk mengecualikan karakter alter dan hanya menampilkan versi orisinal.",
    checked: false
  }
];
